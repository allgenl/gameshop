<header class="main-header">
    ...
    <nav class="main-navigation">
        <ul class="nav-list">
            ...
            <li class="nav-list__item"><a href="{{  route('order.completed') }}" class="nav-list__item__link">Мои заказы</a></li>
    ...
    <div class="header-contact">
        <div class="header-contact__phone"><a href="tel:33-333-33" class="header-contact__phone-link">Телефон: 33-333-33</a></div>
    </div>
    <div class="header-container">
        <div class="payment-container">
            <div class="payment-basket__status">
                <div class="payment-basket__status__icon-block">
                    <a class="payment-basket__status__icon-block__link" href="{{ route('order.current') }}">
